...
//             Graphics.COLOR_ORANGE, Graphics.COLOR_YELLOW, Graphics.COLOR_PURPLE]);
...
//         var pickerOptions = {:title=>title, :pattern=>[factory], :nextArrow=>nextArrow, :previousArrow=>previousArrow, :confirm=>brush};

//         var value = Storage.getValue("color");
//         if (value instanceof Number) {
//             pickerOptions[:defaults] = [factory.getIndex(value)];
//         }
